...
MSPFA.slide.push(() => {
  jQuery(document).ready(function() {
    ...
    if ([753, 754, 755, 756, 757, 758, 759, 760, 761, 762, 763, 764, 765, 766, 767, 768, 769, 770, 771, 772, 773, 774, 775, 776, 777, 778, 779, 780, 781, 782, 783, 784, 785, 786, 788, 789, 790, 791, 792, 793, 794, 795, 796, 797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 818, 819, 820, 821, 822, 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833].includes(parseInt(params.get("p")))) {
      five.play();
      five.loop=true;
    } else {
      five.pause();
    ...
    if ([990, 991, 992, 993, 994, 995, 996, 997, 998, 999, 1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010].includes(parseInt(params.get("p")))) {
      eight.play();
      eight.loop=true;
    } else {
      eight.pause();
    ...
    if ([1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016].includes(parseInt(params.get("p")))) {
      nineteen.play();
      nineteen.loop=true;
    } else {
      nineteen.pause();
